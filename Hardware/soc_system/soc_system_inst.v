	soc_system u0 (
		...
		.en_fpga_external_connection_export    (<connected-to-en_fpga_external_connection_export>),    //    en_fpga_external_connection.export
		...
		.pll_outclk_360mhz_clk                 (<connected-to-pll_outclk_360mhz_clk>),                 //              pll_outclk_360mhz.clk
		.reset_reset_n                         (<connected-to-reset_reset_n>),                         //                          reset.reset_n
		.sram_flag_external_connection_export  (<connected-to-sram_flag_external_connection_export>),  //  sram_flag_external_connection.export
		.sram_s2_address                       (<connected-to-sram_s2_address>),                       //                        sram_s2.address
		.sram_s2_chipselect                    (<connected-to-sram_s2_chipselect>),                    //                               .chipselect
		.sram_s2_clken                         (<connected-to-sram_s2_clken>),                         //                               .clken
		.sram_s2_write                         (<connected-to-sram_s2_write>),                         //                               .write
		.sram_s2_readdata                      (<connected-to-sram_s2_readdata>),                      //                               .readdata
		.sram_s2_writedata                     (<connected-to-sram_s2_writedata>),                     //                               .writedata
		.sram_s2_byteenable                    (<connected-to-sram_s2_byteenable>)                     //                               .byteenable
	);
